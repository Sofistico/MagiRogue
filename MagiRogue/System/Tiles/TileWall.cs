...
namespace MagiRogue.System.Tiles
{
    ...
    public class TileWall : TileBase
    {
        ...
        public TileWall(Point position, bool blocksMovement = true, bool dontBlocksSight = false) :
            base(Color.LightGray, Color.Transparent, '#', (int)MapLayer.TERRAIN, position, blocksMovement, dontBlocksSight)
        {
            Name = "Wall";
            SetMaterial("stone");
        }
